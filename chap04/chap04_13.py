...
# -*- coding: utf-8 -*-
"""
Created on Mon Jan  7 21:22:02 2019
...
status = eval(input("(o-single filer, 1-married jointly, 2-married separately, 3-head of household)\n" +
...
if status == 0:
    if income <= 8350:
        ...
        tax = 8350 * 0.1 + (33950 - 8350) * 0.15 + (82250 - 33950) * 0.25 + \
        (171550 - 82250) * 0.28 + (income - 175150) * 0.33
    else:
        tax = 8350 * 0.1 + (33950 - 8350) * 0.15 + (82250 - 33950) * 0.25 + \
